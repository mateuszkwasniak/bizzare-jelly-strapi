...
export interface ApiDeliveryDelivery extends Schema.SingleType {
  ...
  attributes: {
    method: Attribute.Component<'delivery.delivery-method', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Schema.SingleType {
  ...
  attributes: {
    ...
    sections: Attribute.DynamicZone<
      ['page-sections.hero-section', 'page-sections.arrivals-section']
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    shipping: Attribute.Relation<
      ...
      'api::shipping.shipping'
    >;
    ordered: Attribute.Component<'order.item', true>;
    total: Attribute.Decimal &
      ...
      >;
    status: Attribute.Enumeration<
      ['awaiting', 'paid', 'fulfilling', 'transport', 'delivered', 'cancelled']
    > &
      Attribute.Required;
    ordered_by: Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    delivery: Attribute.Enumeration<['free', 'express', 'pick']> &
      Attribute.Required;
    payment: Attribute.Enumeration<['card', 'paypal']> & Attribute.Required;
...
export interface ApiPaymentOptionPaymentOption extends Schema.SingleType {
  ...
  attributes: {
    option: Attribute.Component<'payment.payment-method', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
  ...
  attributes: {
    ...
    price: Attribute.Decimal &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    category: Attribute.Enumeration<['bizzare', 'animal', 'humanoid', 'item']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductCategoryProductCategory extends Schema.SingleType {
  ...
  attributes: {
    category: Attribute.Component<'product.category', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductPageProductPage extends Schema.SingleType {
  ...
  attributes: {
    SEO: Attribute.Component<'page-properties.seo'> & Attribute.Required;
    shopImage: Attribute.Media & Attribute.Required;
    category: Attribute.Component<'product.category', true> &
      Attribute.Required;
    sortingOption: Attribute.Component<'product.sorting-option', true> &
      Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProductPriceRangeProductPriceRange
  extends Schema.SingleType {
  collectionName: 'product_price_ranges';
  info: {
    singularName: 'product-price-range';
    pluralName: 'product-price-ranges';
    displayName: 'ProductPriceRange';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    range: Attribute.Component<'product.price-range', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::product-price-range.product-price-range',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSignInPageSignInPage extends Schema.SingleType {
  ...
  attributes: {
    signInImage: Attribute.Media & Attribute.Required;
    SEO: Attribute.Component<'page-properties.seo'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiSignUpPageSignUpPage extends Schema.SingleType {
  ...
  attributes: {
    signUpImage: Attribute.Media & Attribute.Required;
    SEO: Attribute.Component<'page-properties.seo', true> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::product-price-range.product-price-range': ApiProductPriceRangeProductPriceRange;
